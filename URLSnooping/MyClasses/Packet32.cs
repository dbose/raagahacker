...
namespace MyClasses
{
	...
	public class Packet32
	{
		...
		public struct PROTOCOL_LIST_ITEM
		{
			public string Name;
		...
		public void InitProtocolListItems()
		{
		}
		...
		public void Start( ListView LVw , RichTextBox Rtx )
		{
		...
		public bool ReadSettings()
		{
			...
			CaptureKey = PacanalKey.OpenSubKey("Capture", true );
			if( CaptureKey == null )
			{
				PacanalKey.Close();
				RKey.Close();
			...
			o = CaptureKey.GetValue("CaptureLimit", 1 );
			try { mCaptureOptions.LimitPackets = ( (int) o ) == 0 ? false : true; }
			catch 
			{ 
				mCaptureOptions.LimitPackets = false;
				CaptureKey.SetValue("CaptureLimit" , 0 );
			}

			o = CaptureKey.GetValue("EachPacketSize", 68 );
			try { mCaptureOptions.PacketSize = (int) o; }
			catch 
			{ 
				mCaptureOptions.PacketSize = 68;
				CaptureKey.SetValue("EachPacketSize" , 68 );
			}

			o = CaptureKey.GetValue("PromiscuousMode", 1 );
			try { mCaptureOptions.PromiscuousMode = ( (int) o ) == 0 ? false : true; }
			catch 
			{ 
				mCaptureOptions.PromiscuousMode = true;
				CaptureKey.SetValue("PromiscuousMode" , 1 );
			}

			o = CaptureKey.GetValue("Filter", "" );
			try { mCaptureOptions.Filter = (string) o; }
			catch 
			{ 
				mCaptureOptions.Filter = "";
				CaptureKey.SetValue("Filter" , "" );
			}

			o = CaptureKey.GetValue("UpdateListInRealTime", 0 );
			try { mDisplayOptions.UpdateListInRealTime = ( (int) o ) == 0 ? false : true; }
			catch 
			{ 
				mDisplayOptions.UpdateListInRealTime = false;
				CaptureKey.SetValue("UpdateListInRealTime" , 0 );
			}

			o = CaptureKey.GetValue("AutomaticScrollInLiveCapture", 0 );
			try { mDisplayOptions.AutomaticScrollInLiveCapture = ( (int) o ) == 0 ? false : true; }
			catch 
			{ 
				mDisplayOptions.AutomaticScrollInLiveCapture = false;
				CaptureKey.SetValue("AutomaticScrollInLiveCapture" , 0 );
			}

			o = CaptureKey.GetValue("LimitToPackets", 0 );
			try { mCaptureLimits.LimitToPackets = ( (int) o ) == 0 ? false : true; }
			catch 
			{ 
				mCaptureLimits.LimitToPackets = false;
				CaptureKey.SetValue("LimitToPackets" , 0 );
			}

			o = CaptureKey.GetValue("PacketSize", 1 );
			try { mCaptureLimits.PacketSize = (int) o; }
			catch 
			{ 
				mCaptureLimits.PacketSize = 1;
				CaptureKey.SetValue("PacketSize" , 1 );
			}

			o = CaptureKey.GetValue("LimitToKiloBytes", 0 );
			try { mCaptureLimits.LimitToKiloBytes = ( (int) o ) == 0 ? false : true; }
			catch 
			{ 
				mCaptureLimits.LimitToKiloBytes = false;
				CaptureKey.SetValue("LimitToKiloBytes" , 0 );
			}

			o = CaptureKey.GetValue("KilobyteSize", 1 );
			try { mCaptureLimits.KilobyteSize = (int) o; }
			catch 
			{ 
				mCaptureLimits.KilobyteSize = 1;
				CaptureKey.SetValue("KilobyteSize" , 1 );
			}

			o = CaptureKey.GetValue("LimitToSeconds", 0 );
			try { mCaptureLimits.LimitToSeconds = ( (int) o ) == 0 ? false : true; }
			catch 
			{ 
				mCaptureLimits.LimitToSeconds = false;
				CaptureKey.SetValue("LimitToSeconds" , 0 );
			}

			o = CaptureKey.GetValue("SecondSize", 1 );
			try { mCaptureLimits.SecondSize = (int) o; }
			catch 
			{ 
				mCaptureLimits.SecondSize = 1;
				CaptureKey.SetValue("SecondSize" , 1 );
			}

			o = CaptureKey.GetValue("EnableMAC", 0 );
			try { mNameResolution.EnableMAC = ( (int) o ) == 0 ? false : true; }
			catch 
			{ 
				mNameResolution.EnableMAC = false;
				CaptureKey.SetValue("EnableMAC" , 0 );
			}

			o = CaptureKey.GetValue("EnableNetwork", 0 );
			try { mNameResolution.EnableNetwork = ( (int) o ) == 0 ? false : true; }
			catch 
			{ 
				mNameResolution.EnableNetwork = false;
				CaptureKey.SetValue("EnableNetwork" , 0 );
			}

			o = CaptureKey.GetValue("EnableTransport", 0 );
			try { mNameResolution.EnableTransport = ( (int) o ) == 0 ? false : true; }
			catch 
			{ 
				mNameResolution.EnableTransport = false;
				CaptureKey.SetValue("EnableTransport" , 0 );
			}

			o = CaptureKey.GetValue("EnableManufacturer", 0 );
			try { mNameResolution.EnableManufacturer = ( (int) o ) == 0 ? false : true; }
			catch 
			{ 
				mNameResolution.EnableManufacturer = false;
				CaptureKey.SetValue("EnableManufacturer" , 0 );
			}

			o = CaptureKey.GetValue("AdapterBufferSize", 512000 );
			try { mCaptureOptions.AdapterBufferSize = (int) o; }
			catch 
			{ 
				mCaptureOptions.AdapterBufferSize = 512000;
				CaptureKey.SetValue("AdapterBufferSize" , 512000 );
			}

			o = CaptureKey.GetValue("BufferSize", 256000 );
			try { mCaptureOptions.BufferSize = (int) o; }
			catch 
			{ 
				mCaptureOptions.BufferSize = 256000;
				CaptureKey.SetValue("BufferSize" , 256000 );
			}

			o = CaptureKey.GetValue("MinBytesToCopy", 4096);
			try { mCaptureOptions.MinBytesToCopy = (int) o; }
			catch 
			{ 
				mCaptureOptions.MinBytesToCopy = 4096;
				CaptureKey.SetValue("MinBytesToCopy" , 4096 );
			}

			o = CaptureKey.GetValue("NumWrites", 1 );
			try { mCaptureOptions.NumWrites = (int) o; }
			catch 
			{ 
				mCaptureOptions.NumWrites = 1;
				CaptureKey.SetValue("NumWrites" , 1 );
			}

			o = CaptureKey.GetValue("ReadTimeOut", 1000 );
			try { mCaptureOptions.ReadTimeOut = (int) o; }
			catch 
			{ 
				mCaptureOptions.ReadTimeOut = 1000;
				CaptureKey.SetValue("ReadTimeOut" , 1000 );
			}

			o = CaptureKey.GetValue("CaptureMode", Packet32h.PACKET_MODE_CAPT );
			try { mCaptureOptions.CaptureMode = (int) o; }
			catch 
			{ 
				mCaptureOptions.CaptureMode = (int) Packet32h.PACKET_MODE_CAPT;
				CaptureKey.SetValue("CaptureMode" , Packet32h.PACKET_MODE_CAPT );
			}
			...
			o = CaptureKey.GetValue("HardwareFilter", Packet32h.NDIS_PACKET_TYPE_PROMISCUOUS );
			try { mCaptureOptions.HardwareFilter = (int) o; }
			catch 
			{ 
				mCaptureOptions.HardwareFilter = Packet32h.NDIS_PACKET_TYPE_PROMISCUOUS;
				CaptureKey.SetValue("HardwareFilter" , Packet32h.NDIS_PACKET_TYPE_PROMISCUOUS );
			}
		...
		public bool SaveSettings()
		{
			...
			CaptureKey = PacanalKey.CreateSubKey("Capture");
			if( CaptureKey == null )
			{
				PacanalKey.Close();
				RKey.Close();
			...
			CaptureKey.SetValue("CaptureLimit", mCaptureOptions.LimitPackets ? 1 : 0 );
			CaptureKey.SetValue("EachPacketSize", mCaptureOptions.PacketSize );
			CaptureKey.SetValue("PromiscuousMode", mCaptureOptions.PromiscuousMode ? 1 : 0 );
			CaptureKey.SetValue("Filter", mCaptureOptions.Filter );
			CaptureKey.SetValue("UpdateListInRealTime", mDisplayOptions.UpdateListInRealTime ? 1 : 0 );
			CaptureKey.SetValue("AutomaticScrollInLiveCapture", mDisplayOptions.AutomaticScrollInLiveCapture ? 1 : 0 );
			CaptureKey.SetValue("LimitToPackets", mCaptureLimits.LimitToPackets ? 1 : 0 );
			CaptureKey.SetValue("PacketSize", mCaptureLimits.PacketSize );
			CaptureKey.SetValue("LimitToKiloBytes", mCaptureLimits.LimitToKiloBytes ? 1 : 0 );
			CaptureKey.SetValue("KilobyteSize", mCaptureLimits.KilobyteSize );
			CaptureKey.SetValue("LimitToSeconds", mCaptureLimits.LimitToSeconds ? 1 : 0 );
			CaptureKey.SetValue("SecondSize", mCaptureLimits.SecondSize );
			CaptureKey.SetValue("EnableMAC", mNameResolution.EnableMAC ? 1 : 0 );
			CaptureKey.SetValue("EnableNetwork", mNameResolution.EnableNetwork ? 1 : 0 );
			CaptureKey.SetValue("EnableTransport", mNameResolution.EnableTransport ? 1 : 0 );
			CaptureKey.SetValue("EnableManufacturer", mNameResolution.EnableManufacturer ? 1 : 0 );
			CaptureKey.SetValue("AdapterBufferSize", mCaptureOptions.AdapterBufferSize );
			CaptureKey.SetValue("BufferSize", mCaptureOptions.BufferSize );
			CaptureKey.SetValue("MinBytesToCopy", mCaptureOptions.MinBytesToCopy );
			CaptureKey.SetValue("NumWrites", mCaptureOptions.NumWrites );
			CaptureKey.SetValue("ReadTimeOut", mCaptureOptions.ReadTimeOut );
			CaptureKey.SetValue("CaptureMode", mCaptureOptions.CaptureMode );
			CaptureKey.SetValue("HardwareFilter", mCaptureOptions.HardwareFilter );
