...
// <KEITH>
            // These lines add the decoding from MAC to IP address so that the display totals is more readable
            mach2mach.Add(LItem.SubItems[ Const.LIST_VIEW_SOURCE_INDEX ].Text, PInternet.Source);
            mach2mach.Add(LItem.SubItems[ Const.LIST_VIEW_DESTINATION_INDEX ].Text, PInternet.Destination);
// </KEITH>
