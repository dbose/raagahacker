...
namespace RaagaHacker
{
	...
	public class frmNewWindowJukeBox : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.ctlRaagaJukebox.Size = new System.Drawing.Size(472, 263);
			...
			this.Text = "Untitled - Raaga Jukebox";
					...
					if (framePlayer != null)
					{
						...
						if (m_isRecording == true)
						{
							...
							if (m_sCurrentSongInfo != null)
							{
								...
								{
									if (File.Exists(m_sCurrentMusicRecordingPath + "\\" + 
										m_sCurrentSongInfo.SongTitle + ".wav") == true)
									{
										File.Delete(m_sCurrentMusicRecordingPath + "\\" + 
										m_sCurrentSongInfo.SongTitle + ".wav");
									}
								}
						...
						//
						//No way to get javascript string to C# strng
