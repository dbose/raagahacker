...
namespace RaagaHacker.Installer.RealPlayer
{
	...
	public class RealPlayerSetup : System.Windows.Forms.Form
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(RealPlayerSetup));
			...
			this.btnInstallRealPlayer.Image = ((System.Drawing.Image)(resources.GetObject("btnInstallRealPlayer.Image")));
			...
			this.label3.Text = "WARNING : RealPlayer is the product of REALNETWORKS, INC. RaagaHacker will not be" +
				" responsible for any damage or security vulnerability caused by RealPlayer. Raag" +
				"aHacker also no way involved in the Licensing policy of RealPlayer";
			// 
			// RealPlayerSetup
			// 
